...
- **Remito en PDF (A4, original + duplicado)**: `@react-pdf/renderer` (se carga bajo demanda) arma por pedido una hoja A4 con el ORIGINAL y otra con el DUPLICADO (se archivan por separado), logo, datos fiscales, N° correlativo (`0001-00000123`), tabla KILOS · DETALLE · PRECIO X UN. · PRECIO TOTAL, cajas adeudadas, saldo, firma conforme y total. Botones en la tarjeta del pedido, la nota del día (por camión e **Imprimir todos los remitos** del día), la carga del camión y `/imprimir`: **Remito PDF** descarga, **Compartir** abre la hoja nativa del celular (WhatsApp, correo) e **Imprimir** abre el PDF para mandarlo a la impresora. Los logos viven en `public/brand/`.
