...
- **Remito interno 10×15** (`/imprimir?tipo=remito&pedido=` y `tipo=remitos&fecha=&repartidor=`): calcado del talonario (marca, X, datos fiscales de `business.fiscal`, Nº, fecha en casilleros, cliente/calle/localidad/cel., KILOS · DETALLE · PRECIO X UNIDAD · PRECIO TOTAL, CAJAS ADEUDADAS, TOTAL, saldo anterior), `@page 100mm 150mm`, uno por hoja.
